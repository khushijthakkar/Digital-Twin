...
def run_simulation():
   try:
       ...
       total_semester_credits = sum(credits_list)
       ...
       # 🔴 WARNING LOGIC
       warning = None
       if semester in ["Fall", "Spring"] and total_semester_credits > 15:
           warning = "Caution: Exceeding recommended course credits."
       elif semester == "Summer" and total_semester_credits > 8:
           warning = "Caution: Exceeding recommended course credits."
